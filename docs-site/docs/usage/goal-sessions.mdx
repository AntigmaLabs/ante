...
description: "Keep Ante working until a concrete success condition is met"
---
...
Goal loops are part of Ante's wire protocol: `Op::Goal` carries set, clear, and status commands, so [server-mode](/usage/serve) clients can drive them the same way the TUI does.
