...
Ante can run entirely offline using local GGUF models via [llama.cpp](https://github.com/ggerganov/llama.cpp). This means no API keys, no internet, and no data leaving your machine. Ante manages the inference engine natively.
