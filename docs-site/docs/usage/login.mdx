...
:::tip
You can also set API keys directly via environment variables (e.g. `ANTHROPIC_API_KEY`) or in the [providers configuration](/usage/providers). OAuth login is an alternative for providers that support it.
:::
