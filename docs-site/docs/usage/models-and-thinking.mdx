...
Switching providers keeps the current conversation — its messages, title, and permission mode carry over, and the new provider picks up on your next message.
