...
Anthropic exposes `xhigh` on Claude Sonnet 5 and Opus 5, Opus 4.7/4.8, and the always-thinking Fable/Mythos 5 family. Opus and Sonnet 4.6 retain their four active adaptive levels (`low` through `high`, then `max`) plus the `min` off position.
