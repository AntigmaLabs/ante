...
|---|---|---|
| `SessionStart` | `SessionInitialized` | Session initialized with identity, mutable settings, skills, and subagents |
| `SessionUpdated` | `SessionInitialized` | Session updated in place, repeating the session's equipped skills and subagents |
