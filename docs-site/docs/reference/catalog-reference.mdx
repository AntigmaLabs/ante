...
| Model | Description | Context |
|---|---|---|
| `gemini-3.8-flash` | Gemini 3.8 Flash for fast agentic and multimodal workflows | 1.05M |
...
| `google/gemini-3.8-flash` | Gemini 3.8 Flash for fast multimodal agentic workflows | 1.05M |
